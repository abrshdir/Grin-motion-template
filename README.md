...
Now go to the `Grin` folder and open a terminal like the image below.

*if you are in Windows 7 and below, it looks like below*

![right click window](images/1.png)

*if you are in Windows 10 or 11, it looks like below*

![right click window](images/2.png)

Now type in the following command on the terminal window shown below:

```npm install```

![right click window](images/3.png)

If you have not made any mistake, you may/will see the following message at the bottom after installation is finished:
...
If you have not made any mistake, after the terminal window is done running, it will open a browser on [http://localhost:3000](http://localhost:3000).
...
![right click window](images/8.png)
...
The build folder will be found in the folder of Grin as shown below. Copy the insides of the build folder and paste it to your hosting server folder.

![right click window](images/4.png)
